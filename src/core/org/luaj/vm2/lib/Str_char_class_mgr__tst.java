...
public class Str_char_class_mgr__tst {
	...
	@Test public void Punct() {
		...
		fxt
		.Init("_", "\uFE4F")
		.Test(fxt.Rule(MGR_U8).Is(CLASS_PUNCT, CLASS_WORD, CLASS_SPACE).Is_not(CLASS_UPPER, CLASS_ALPHA, CLASS_LOWER, CLASS_DIGIT, CLASS_CTRL, CLASS_HEX, CLASS_NULL))
	...
	@Test public void Space() {
		...
		fxt
		.Init("\uFE4F")
		.Test(fxt.Rule(MGR_U8).Is(CLASS_SPACE, CLASS_PUNCT, CLASS_WORD).Is_not(CLASS_UPPER, CLASS_ALPHA, CLASS_LOWER, CLASS_DIGIT, CLASS_CTRL, CLASS_HEX, CLASS_NULL))
